...
class UltraRobustArchivalEngine:
    ...
    def export_scene_clip(self, video, scene_info, max_duration=30, with_audio=False):
        ...
        try:
            ...
            # Write clip with or without audio based on parameter
            clip.write_videofile(
                str(clip_path),
                codec='libx264',
                audio=with_audio,  # Use the parameter
                verbose=False,
                logger=None,
                preset='fast',
                threads=2,
    ...
    def analyze_and_export_scenes(self, threshold=30.0, export_clips=True, max_scenes=None, max_clip_duration=2000, with_audio=False):
        """
        ...
        try:
            ...
            for i, scene in enumerate(scene_list):
                ...
                if export_clips and clips_exported < 2000:  # Limit to 2000 clips for storage
                    if self.export_scene_clip(video, scene_info, max_duration=max_clip_duration, with_audio=with_audio):
                        clips_exported += 1
...
<body>
    ...
    def run_complete_pipeline(self, export_clips=True, max_scenes=None, 
        ...
        scenes = self.analyze_and_export_scenes(
            ...
            max_clip_duration=2000,  # 2000 second max for web playback
