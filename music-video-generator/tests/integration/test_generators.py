...
class TestMusicVideoGenerators:
    ...
    def test_ultrarobust_generator_basic(self, test_video_path, test_audio_path, temp_output_dir):
    ...
    def test_premiere_style_engine(self, test_video_path, test_audio_path, temp_output_dir):
        ...
        try:
            ...
            spec = importlib.util.spec_from_file_location(
                "premiere_engine", 
                Path(__file__).parent.parent.parent / "premiere_style_archival_engine.py"
            )
    ...
    def test_robust_music_video_generator(self, test_video_path, test_audio_path, temp_output_dir):
...
class TestGeneratorWorkflow:
    ...
    def test_end_to_end_workflow_simulation(self, test_video_path, test_audio_path, temp_output_dir):
        ...
        output_dir = temp_output_dir / f"workflow_test_{datetime.now().strftime('%H%M%S')}"
